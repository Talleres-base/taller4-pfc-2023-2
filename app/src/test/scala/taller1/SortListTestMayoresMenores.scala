...
class SortListTestMayoresMenores extends AnyFunSuiteLike {
  ...
  test("testMayoresQueCase1") {
    val testListA = List(10,3,9,12,1,4)
  ...
  test ("testMayoresQueCase2") {
    val testListA = List(10,3,9,12,1,4)
    val objSortList = new SortList()
    assert(objSortList.mayoresQue(testListA, 0).toSet == Set(10,3,9,12,1,4))
  }
  ...
  test ("testMayoresQueCase4") {
    val testListA = List(10,3,9,12,1,4)
    val objSortList = new SortList()
    assert(objSortList.mayoresQue(testListA, 1).toSet == Set(10,3,9,12,4))
  }

  test("testMenoresQueCase1") {
    val testListA = List(10,3,9,12,1,4)
    val objSortList = new SortList()
    assert(objSortList.menoresQue(testListA, 5).toSet == Set(3,1,4))
  ...
  test ("testMenoresQueCase3") {
    val testListA = List(10,3,9,12,1,4)
    val objSortList = new SortList()
    assert(objSortList.menoresQue(testListA, 12).toSet == Set(10,3,9,1,4))
  }
